    ...
    <div className="max-w-5xl mx-auto">
      ...
      {!links || links.length === 0 ? (
        <div className="text-center py-24 card-saweria flex flex-col items-center">
          ...
          <h3 className="text-xl font-bold text-foreground mb-2">Belum ada link</h3>
          <p className="text-muted-foreground mb-6">Yuk, buat link pendek pertamamu sekarang!</p>
        </div>
      ) : (
