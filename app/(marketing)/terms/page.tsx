  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 text-[#2d3748]">
      ...
      <div className="prose prose-blue max-w-none space-y-8 text-gray-600">
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">1. Deskripsi Layanan</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">2. Akun Pengguna</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">3. Larangan Konten (Zero Tolerance)</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">4. Penggunaan Fitur Microsite & Integrasi Drive</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">5. Penafian (Disclaimer)</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">6. Perubahan Ketentuan</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">7. Kontak</h3>
          <p>
