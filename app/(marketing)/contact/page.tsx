...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return locale === "en"
    ? {
        title: "Contact Us",
        description: "Support contact and location of Institut Teknologi Tangerang Selatan.",
      }
    : {
        title: "Hubungi Kami",
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-12 md:flex-row">
      ...
      <div className="flex-1 space-y-8">
        <div>
          <h1 className="mb-4 text-4xl font-extrabold text-foreground">{t.title}</h1>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">{t.addressLabel}</h2>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">{t.emailLabel}</h2>
              <a
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">{t.phoneLabel}</h2>
              <a
