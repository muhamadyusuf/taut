  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 text-[#2d3748]">
      ...
      <div className="prose prose-blue max-w-none space-y-8 text-gray-600">
        <section>
          <p className="lead italic text-gray-500">
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">3. Kepatuhan Terhadap Kebijakan Data Pengguna Google</h3>
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 text-sm">
            <p className="mb-2 font-semibold">
              Pernyataan Penggunaan Terbatas (Limited Use Disclosure):
            </p>
            <p>
              Penggunaan dan transfer informasi yang diterima oleh Singkat.in dari Google APIs ke aplikasi lain mana pun akan mematuhi <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Kebijakan Data Pengguna Layanan Google API</a>, termasuk persyaratan <em>Limited Use</em>.
            </p>
            <p className="mt-2">
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">4. Keamanan Data</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-bold text-[#2d3748] mb-3">5. Hak Pengguna & Kontak</h3>
          <p className="mb-4">
            Anda berhak untuk mengakses, mengoreksi, atau menghapus data Anda kapan saja. Anda juga dapat mencabut akses Singkat.in ke Google Drive Anda kapan saja melalui halaman <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Pengaturan Keamanan Google</a>.
          </p>
          <p>
